...
\PY{k}{def} \PY{n+nf}{U\PYZus{}pol}\PY{p}{(}\PY{n}{maxindex}\PY{p}{,} \PY{n}{k}\PY{p}{)}\PY{p}{:}
    ...
    \PY{k}{for} \PY{n}{ik}\PY{p}{,} \PY{n}{k\PYZus{}cur} \PY{o+ow}{in} \PY{n+nb}{enumerate}\PY{p}{(}\PY{n}{k}\PY{p}{)}\PY{p}{:}
        \PY{n}{U}\PY{p}{[}\PY{n}{ik}\PY{p}{]} \PY{o}{=} \PY{n}{util}\PY{p}{(}\PY{n+nb}{max}\PY{p}{(}\PY{n}{f}\PY{p}{(}\PY{n}{k\PYZus{}cur}\PY{p}{)} \PY{o}{\PYZhy{}} \PY{n}{k}\PY{p}{[}\PY{n}{maxindex}\PY{p}{[}\PY{n}{ik}\PY{p}{]}\PY{p}{]}\PY{p}{,} \PY{l+m+mf}{1E\PYZhy{}6}\PY{p}{)}\PY{p}{)}
    \PY{k}{return} \PY{n}{U}
...
\PY{k}{def} \PY{n+nf}{ss\PYZus{}policy\PYZus{}howard}\PY{p}{(}\PY{n}{k}\PY{p}{,} \PY{n}{howard}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{:}
    ...
    \PY{k}{for} \PY{n}{it} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{20000}\PY{p}{)}\PY{p}{:}
        ...
        \PY{k}{if} \PY{n}{howard} \PY{o}{==} \PY{l+m+mi}{1}\PY{p}{:}
            \PY{n}{V\PYZus{}h} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{copy}\PY{p}{(}\PY{n}{V}\PY{p}{)}
            \PY{n}{V\PYZus{}hold} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{copy}\PY{p}{(}\PY{n}{V}\PY{p}{)}
            ...
            \PY{k}{for} \PY{n}{it2} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{2000}\PY{p}{)}\PY{p}{:}

                \PY{n}{V\PYZus{}h} \PY{o}{=} \PY{n}{Howard}\PY{p}{(}\PY{n}{ind}\PY{p}{,} \PY{n}{k}\PY{p}{,} \PY{n}{V\PYZus{}h}\PY{p}{,} \PY{n}{UC}\PY{p}{)}   
\PY{c+c1}{\PYZsh{}                 print(np.linalg.norm(V\PYZus{}h \PYZhy{} V\PYZus{}hold))}
                \PY{k}{if} \PY{n}{it} \PY{o}{\PYZpc{}} \PY{l+m+mi}{10} \PY{o}{==} \PY{l+m+mi}{1} \PY{o+ow}{and}  \PY{n}{np}\PY{o}{.}\PY{n}{linalg}\PY{o}{.}\PY{n}{norm}\PY{p}{(}\PY{n}{V\PYZus{}h} \PY{o}{\PYZhy{}} \PY{n}{V\PYZus{}hold}\PY{p}{)} \PY{o}{\PYZlt{}} \PY{l+m+mf}{1E\PYZhy{}10}\PY{p}{:}
\PY{c+c1}{\PYZsh{}                     print(\PYZdq{}convergence in\PYZdq{}, it2, \PYZdq{} iterations!\PYZdq{})}
                    \PY{n}{V} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{copy}\PY{p}{(}\PY{n}{V\PYZus{}h}\PY{p}{)}
                    \PY{n}{Vold} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{copy}\PY{p}{(}\PY{n}{V\PYZus{}h}\PY{p}{)}
                    \PY{k}{break}
                    
                \PY{k}{elif} \PY{n}{it2} \PY{o}{==} \PY{l+m+mi}{2000}\PY{p}{:}
                
                        \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Howard Improvement did not converge!}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{;}
                    
                \PY{n}{V\PYZus{}hold} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{copy}\PY{p}{(}\PY{n}{V\PYZus{}h}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\PY{k}{def} \PY{n+nf}{Euler\PYZus{}err\PYZus{}cubic}\PY{p}{(}\PY{n}{kplus}\PY{p}{,} \PY{n}{tck}\PY{p}{,} \PY{n}{k}\PY{p}{)}\PY{p}{:}
    \PY{n}{err} \PY{o}{=} \PY{n}{up}\PY{p}{(}\PY{n}{f}\PY{p}{(}\PY{n}{k}\PY{p}{)} \PY{o}{\PYZhy{}} \PY{n}{kplus}\PY{p}{)} \PY{o}{\PYZhy{}} \PY{n}{beta} \PY{o}{*} \PY{n}{fk}\PY{p}{(}\PY{n}{kplus}\PY{p}{)} \PY{o}{*} \PY{n}{up}\PY{p}{(}\PY{n}{interpolate}\PY{o}{.}\PY{n}{splev}\PY{p}{(}\PY{n}{kplus}\PY{p}{,} \PY{n}{tck}\PY{p}{)}\PY{p}{)}
...
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
CPU times: user 24.7 s, sys: 48.1 ms, total: 24.7 s
Wall time: 24.5 s
    \end{Verbatim}
...
\PY{n}{kstar} \PY{o}{=} \PY{n}{optimize}\PY{o}{.}\PY{n}{fixed\PYZus{}point}\PY{p}{(}\PY{n}{fun}\PY{p}{,} \PY{p}{[}\PY{l+m+mi}{7}\PY{p}{,} \PY{l+m+mi}{10}\PY{p}{]}\PY{p}{)}
\PY{n}{kstar}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{o}{\PYZpc{}}\PY{k}{prun} c = ss\PYZus{}policy\PYZus{}endog(k)
\end{Verbatim}
\end{tcolorbox}
